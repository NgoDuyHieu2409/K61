          ...
          <table class="table table-bordered">
            ...
            switch ($action) {
             ...
             if(count($carts)){
               ...
               $sql11="SELECT banan.*, min(oder.trangthai) as trangthai FROM banan LEFT JOIN oder on banan.id_banan = oder.id_banan where banan.id_banan = $id_banan and ( oder.trangthai=1 or oder.trangthai=2 ) GROUP BY banan.id_banan ";
                $result11 = mysqli_query($conn,$sql11);
                if (mysqli_num_rows($result11) == 0){
                  $sql11="INSERT INTO `order_table`(`id_user`, `id_ban`) VALUES ($id_user,$id_banan)";
                     $conn->query($sql11);
                }
            ...
            break;
                          ...
                          <div class="col-lg-6 croll" style="height: calc(100vh - 65px);">
      <!-- body product -->
